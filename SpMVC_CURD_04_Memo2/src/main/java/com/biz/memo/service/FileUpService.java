...
public class FileUpService {
	 ...
	 *  
	 *  실제 그 서버가 가지고 있는 resources 폴더의 위치를
	 *  알아야할 필요가 있다.
	 *  
	...
	// web에서 전잘된 file을 서버의 어딘가로 저장하는 method
		public String fileUp(MultipartFile upFile) {
			...
			try {
				 ...
				 * 악의적인 상용자가 기존 업로드된 파일 이름과
				 * 같음이름의 다른 파일을 업로드 하면
				 * 이미 업로드된 파일이 변경되어 버린다.
				 * 
				 * 서버에 저장을 파일 이름을 변환 시켜야 한다.
				 */
				...
				// commons-io, commonsfileupload를 사용하는 방법
				// 6 ~ 9를 한줄로
